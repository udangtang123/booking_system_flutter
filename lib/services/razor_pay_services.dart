...
class RazorPayServices {
  ...
  static void handlePaymentSuccess(PaymentSuccessResponse response) async {
    savePay(data: dataValue, paymentMethod: PAYMENT_METHOD_RAZOR, paymentStatus: SERVICE_PAYMENT_STATUS_PAID, txnId: response.paymentId);
  }
...
Future<void> savePay({
  ...
  Map request = {
    ...
    BookingServiceKeys.totalAmount: data.bookingDetail!.isPackageBooking ? totalAmount : totalAmount ??
