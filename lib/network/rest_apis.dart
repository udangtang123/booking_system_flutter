...
//region Video Api
Future<VideoResponse> getVideoList(int catId ,String page) async {
  return VideoResponse.fromJson(await handleResponse(await buildHttpResponse('video-list?page=$page&per_page=50', method: HttpMethod.GET)));
}
//endregion
