...
class MyPostDetailScreen extends StatefulWidget {
  ...
  MyPostDetailScreen({required this.postRequestId, required this.postJobData, required this.callback});
            ...
            if (snap.hasError) {
              ...
              return Stack(
                children: [
                  ...
                  if (widget.postJobData.status == JOB_REQUEST_STATUS_ASSIGNED)
                    Positioned(
                      bottom: 16,
                      left: 16,
                      right: 16,
