...
import 'package:booking_system_flutter/screens/video/video_screen.dart';
          ...
          child: NavigationBarTheme(
            ...
            child: NavigationBar(
              ...
              destinations: [
                ...
                NavigationDestination(
                  icon: ic_show.iconImage(color: appTextSecondaryColor),
                  selectedIcon: ic_show.iconImage(color: context.primaryColor),
