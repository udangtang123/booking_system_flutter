        ...
        Column(
          ...
          children: [
            data.datetime
                .validate()
                .toString()
                .isNotEmpty ? Text(formatDate(data.datetime..validate().toString(), format: HOUR_12_FORMAT), style: secondaryTextStyle(size: 12)) : SizedBox(),
            8.height,
            data.datetime
                .validate()
                .toString()
                .isNotEmpty ? Text(formatDate(data.datetime..validate().toString(), format: DATE_FORMAT_4), style: primaryTextStyle(size: 14)) : SizedBox(),
          ],
        ).withWidth(55),
        16.width,
        Column(
