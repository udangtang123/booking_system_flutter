            ...
            children: [
              ...
              Column(
                ...
                children: [
                  ...
                  4.height,
                  Marquee(
                    child: Text(bookingData.isPackageBooking ? '${bookingData.bookingPackage!.name.validate()}':'${bookingData.serviceName.validate()}', style: boldTextStyle(size: 16), overflow: TextOverflow.ellipsis, maxLines: 1),
                  ),
                  4.height,
